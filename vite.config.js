  ...
  return {
    ...
    transform(code, id) {
      ...
      if (isApp) {
        ...
        patched = patched.replace(
          '<section className="panel">\n              <div className="section-title"><h2>Dépenses à récupérer</h2>',
...
function leisureVacationsIntegration() {
  return {
    ...
    transform(code, id) {
      ...
      patched = patched.replace(
        '<section className="panel">\n                <div className="section-title"><h2>Contrôle de la balance Belfius</h2>',
